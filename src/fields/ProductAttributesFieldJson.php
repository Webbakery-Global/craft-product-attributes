...
class ProductAttributesFieldJson extends Field implements SortableFieldInterface, InlineEditableFieldInterface
{
  /**
   * @inheritdoc
   */
  ...
  {
    return Craft::t('product-attribute-fields', 'Product Attributes JSON');
  }
  ...
  public function getInputHtml($value, ElementInterface $element = null): string
  {
    ...
    return Craft::$app->getView()->renderTemplate(
      'product-attribute-fields/_layouts/product-attributes-json/index',
      [
        'name' => $this->handle,
        'value' => $value,
      ]
